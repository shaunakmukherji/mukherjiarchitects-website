...
const ScrollWheelIndicator: React.FC = () => {
  ...
  useEffect(() => {
    if (currentView !== 'HOME' && currentView !== 'PROJECT_DETAIL' && currentView !== 'PORTFOLIO_FEED') return;
    ...
    const handleScroll = () => {
      ...
      if (currentView !== 'HOME') return; // section dots only on home
  ...
  if (currentView !== 'HOME' && currentView !== 'PROJECT_DETAIL' && currentView !== 'PORTFOLIO_FEED') {
    return null;
  }
